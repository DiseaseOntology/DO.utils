...
test_that("lexiclean.character() works", {
  expect_equal(
    ...
    c(
      ...
      "jalilisyndrome",
      "hepatitisd",
      "dilatedcardiomyopathyiff",
      "chromosomexvqxxvdeletionsyndrome",
      "spinocerebellarataxiatypexixxxii",
      "addisonsdisease",
      "arthrogryposisrenaldysfunctionandcholestasisi",
      "trichorhinophalangealsyndrometypeii",
      "nucleartypemitochondrialcomplexideficiencyxxii",
...
test_that("lexiclean.character() individual modifications work", {
  ...
  expect_equal(
    ...
    c(
      ...
      "Jalili syndrome",
      "hepatitis D",
      "dilated cardiomyopathy IFF",
      "chromosome XVqXXV deletion syndrome",
      "spinocerebellar ataxia type XIX/XXII",
      "Addison's disease",
      "arthrogryposis, renal dysfunction, and cholestasis I",
      "trichorhinophalangeal syndrome type II",
      "nuclear type mitochondrial complex I deficiency XXII",
  ...
  expect_equal(
    ...
    c(
      ...
      "Jalilisyndrome",
      "hepatitisD",
      "dilatedcardiomyopathy1FF",
      "chromosome15q25deletionsyndrome",
      "spinocerebellarataxiatype19/22",
      "Addison'sdisease",
      "arthrogryposis,renaldysfunction,andcholestasis1",
      "trichorhinophalangealsyndrometypeII",
      "nucleartypemitochondrialcomplexIdeficiency22",
