...
#' Extract a Response URL (INTERNAL)
#'
#' Extract a URL from a response generated by [httr](httr::httr).
#'
#' @param x An [httr::response] object.
#' @param .which The URL to extract, as a string. Available options include:
#'
#' * "first": the initial request URL.
#' * "last": the final URL visited (last redirect).
#'
#' @keywords internal
