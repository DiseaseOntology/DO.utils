...
#' @param ... Additional arguments passed on to [extract_pmid.elink] method.
#'
#' @export
...
extract_doid_url <- function(doid_edit, include_obsolete = FALSE, quiet = FALSE,
                             w_raw_match = FALSE, show_url_string = FALSE) {
